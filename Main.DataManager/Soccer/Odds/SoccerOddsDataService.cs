...
{
    public class SoccerOddsDataService : ISoccerOddsDataService
    {
        ...
        public SoccerOddsDataService(ISoccerOddsRepositoryService<SoccerFullTimeMatchBetEntity> soccerFullTimeRepositoryService, ISoccerOddsRepositoryService<SoccerFirstHalfMatchBetEntity> soccerFirstHalfRepositoryService, ISoccerOddsRepositoryService<SoccerSecondHalfMatchBetEntity> soccerSecondHalfRepositoryService, IOddsDataSourceService oddsDataSourceService)
        {
